...
\setlength{\cftbeforechapterskip}{1pt} % odstępy w spisie treści przed rozdziałem, działa w korelacji z:
\renewcommand{\insertchapterspace}{
\addtocontents{lof}{\protect\addvspace{5pt}}
\addtocontents{lot}{\protect\addvspace{5pt}}
\addtocontents{lol}{\protect\addvspace{5pt}}
\addtocontents{l}{\protect\addvspace{5pt}}
}
\renewcommand{\aftertoctitle}{\afterchaptertitle\vspace{-1pt}} % co trzeba zmienić, by tekst w spisie treści zaczynał się na tej samej wysokości co w innych spisach
...
%%  Metadane dokumentu 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Szablon pracy dyplomowej inżynierskiej/magisterskiej, wersja 0.6}
\titleShort{Szablon pracy dyplomowej ...}
\titleEN{Engineering/master thesis template, version 0.6}
\author{Imię Nazwisko}
\uczelnia{POLITECHNIKA WROCŁAWSKA}
\wydzial{WYDZIAŁ ELEKTRONIKI}
\kierunek{INFORMATYKA}
\specjalnosc{INŻYNIERIA SYSTEMÓW INFORMATYCZNYCH}
\promotor{tytuł, Imię Nazwisko, Jednostka}
\date{WROCŁAW, 2021}
